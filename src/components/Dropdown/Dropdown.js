        ...
        <>
            {
                ...
                <div className={styles.dropdown}>
                    <img 
                        ...
                        src={makerType.name.includes("none") ?  "/img/choose.svg":makerType.url}
                        alt="choose" 
                    />
                    {isShown && 
                        <div 
                        ...
                        >
                            {
                                imgLinkArray.map((img, index) => (
                                    <img 
                                        ...
                                        style={(makerType.name.includes(img.name)  ? {backgroundColor: "#FFF"}:{})}
                                        key = {index} 
                                        src={img.url} 
                                        alt={img.name}
                                    />
                ...
                <div className={styles.dropdown}>
                    <img 
                        onMouseEnter={() => setIsShown(true)}
                        onMouseLeave={() => setIsShown(false)}
                        src={itemType.name.includes("none") ?  "/img/choose.svg":itemType.url}
                        alt="choose" 
                    />
                    {isShown && !makerType.name.includes("none") && 
                        <div 
                            onMouseEnter={() => setIsShown(true)}
                            onMouseLeave={() => setIsShown(false)}
                            style={{position:"absolute", left: moveDrop(imgLinkObj[makerType.name])}} 
                            className={styles.drop}
                        >
                            {
                                ...
                                imgLinkObj[makerType.name].map((img, index) => (
                                    ...
                                    <img 
                                        ...
                                        style={(itemType.name === img.name  ? {backgroundColor: "#FFF"}:{})}
                                        key = {index} 
                                        src={img.url} 
                                        alt={img.name}
                                    />
                ...
                <div className={styles.dropdown}>
                    <img 
                        onMouseEnter={() => setIsShown(true)}
                        onMouseLeave={() => setIsShown(false)}
                        src={itemName.name.includes("none") ?  "/img/choose.svg":itemName.url}
                        alt="choose" 
                    />
                    {isShown && !itemType.name.includes("none") && 
                        <div 
                            onMouseEnter={() => setIsShown(true)}
                            onMouseLeave={() => setIsShown(false)}
                            style={{position:"absolute", left: moveDrop(imgLinkObj[itemType.name])}} 
                            className={styles.drop}
                        >
                            {
                                imgLinkObj[itemType.name].map((img, index) => (
                                    <img 
                                        ...
                                        style={(itemName.name === img.name   ? {backgroundColor: "#FFF"}:{})}
                                        key = {index} 
                                        src={img.url} 
                                        alt={img.name}
                                    />
